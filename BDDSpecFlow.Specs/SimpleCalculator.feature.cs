...
#line hidden
        ...
        public virtual void FeatureSetup()
        {
            ...
            TechTalk.SpecFlow.FeatureInfo featureInfo = new TechTalk.SpecFlow.FeatureInfo(new System.Globalization.CultureInfo("en-US"), "Simple Calculator", "In order to avoid silly mistakes\r\nAs a math idiot\r\nI want to be told the result o" +
                    "f simple arithematics", ProgrammingLanguage.CSharp, ((string[])(null)));
        ...
        [NUnit.Framework.TestCaseAttribute("20", "13", "7", null)]
        [NUnit.Framework.TestCaseAttribute("-1", "-2", "1", null)]
        [NUnit.Framework.TestCaseAttribute("10", "51", "-41", null)]
        public virtual void SubtractTwoNumbers(string input1, string input2, string output, string[] exampleTags)
        {
...
#line 9
 testRunner.When("I use Subtract in the calculator", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "When ");
#line 10
...
#line hidden
        ...
        [NUnit.Framework.TestCaseAttribute("10", "5", "50", null)]
        [NUnit.Framework.TestCaseAttribute("20", "13", "260", null)]
        [NUnit.Framework.TestCaseAttribute("-1", "-2", "2", null)]
        public virtual void MultiplyTwoNumbers(string input1, string input2, string output, string[] exampleTags)
        {
...
#line 21
 testRunner.And(string.Format("the second number is \"{0}\"", input2), ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "And ");
#line 22
 testRunner.When("I use Multiply in the calculator", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "When ");
#line 23
 testRunner.Then(string.Format("the result should be \"{0}\"", output), ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "Then ");
#line hidden
            this.ScenarioCleanup();
